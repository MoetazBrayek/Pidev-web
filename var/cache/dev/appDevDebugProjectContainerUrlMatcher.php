...
class appDevDebugProjectContainerUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($rawPathinfo)
    {
        ...
        // calendars
        if (preg_match('#^/(?P<_locale>|fr||ch)(?P<_S>/?)Admin/calendar$#sD', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, ['_route' => 'calendars']), array (  '_controller' => 'AdminBundle\\Controller\\DefaultController::calendarAction',  '_locale' => 'en',  '_S' => '/',));
        }
        ...
        // date
        if (preg_match('#^/(?P<_locale>|fr||ch)(?P<_S>/?)eventment/date$#sD', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, ['_route' => 'date']), array (  '_controller' => 'EvenementBundle\\Controller\\EvenementController::modifyAction',  '_locale' => 'en',  '_S' => '/',));
        }

        // addCalendar
        if (preg_match('#^/(?P<_locale>|fr||ch)(?P<_S>/?)eventment/addCalendar$#sD', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, ['_route' => 'addCalendar']), array (  '_controller' => 'EvenementBundle\\Controller\\EvenementController::addCalendarAction',  '_locale' => 'en',  '_S' => '/',));
        }

        // resize
        if (preg_match('#^/(?P<_locale>|fr||ch)(?P<_S>/?)eventment/resize$#sD', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, ['_route' => 'resize']), array (  '_controller' => 'EvenementBundle\\Controller\\EvenementController::resizeAction',  '_locale' => 'en',  '_S' => '/',));
        }
        ...
        if (preg_match('#^/(?P<_locale>|fr||ch)(?P<_S>/?)full\\-calendar/load$#sD', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, ['_route' => 'ancarebeca_full_calendar_load']), array (  '_controller' => 'AncaRebeca\\FullCalendarBundle\\Controller\\CalendarController::loadAction',  '_locale' => 'en',  '_S' => '/',));
        }
